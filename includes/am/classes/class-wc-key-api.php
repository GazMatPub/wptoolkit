...
class WPToolKit_Plugin_Manager_Key {
	...
	public function create_software_api_url( $args ) {
		...
		$api_url = add_query_arg( 'wc-api', 'am-software-api', WPT()->upgrade_url );
	...
	public function activate( $args ) {
		...
		$defaults = array(
			'request' 			=> 'activation',
			'product_id' 		=> WPT()->ame_product_id,
			'instance' 			=> WPT()->ame_instance_id,
			'platform' 			=> WPT()->ame_domain,
			'software_version' 	=> WPT()->ame_software_version
			);
