...
class WPToolKit_Plugin_Manager_Update_API_Check {
	...
	public function switched_subscription_error_notice( $message ){
		...
		echo sprintf( '<div id="message" class="error"><p>' . __( 'You changed the subscription for %s, so you will need to enter your new WPToolKit License Key in the settings page. The License Key should have arrived in your email inbox, if not you can get it by logging into your account <a href="%s" target="_blank">dashboard</a>.', $this->text_domain ) . '</p></div>', $this->product_id, $this->renew_license_url ) ;
